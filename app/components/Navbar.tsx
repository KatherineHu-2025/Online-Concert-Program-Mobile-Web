...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-[#2B2F3E] text-[#E8D1C5] p-4">
      <div className="flex justify-around items-center">
        ...
        <Link href="/scanner" className="flex flex-col items-center">
          <div className="bg-[#E8D1C5] rounded-full p-4 -mt-8">
          ...
          <span className="text-sm mt-1">Scanner</span>
        </Link>
